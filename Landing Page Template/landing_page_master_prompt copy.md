...
COLOR PALETTE:
- REFERENCE: Based on official Accrue logo colors
- PRIMARY: Deep navy blue (#1B365D) - Main brand color from logo
- ACCENT: Medium blue (#4A90B8) - Secondary blue from logo stepped elements
- SECONDARY: Light blue (#7FB3D3) - Lighter blue for accents and highlights
- NEUTRAL: Charcoal grays (#3A3A3A range) for text
- BACKGROUND: Pure white (#FFFFFF) with light gray sections (#F8F9FA)
- CTA BUTTONS: Use primary navy (#1B365D) or medium blue (#4A90B8) with white text
