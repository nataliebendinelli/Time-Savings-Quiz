...
Review the ebook content and answer:
1. Does this clearly address back-office burnout?
2. Is the "Now you know it's right" message evident?
3. Are the three pillars (eliminate, crush, call) represented?
4. Does it feel human-first rather than tech-first?
5. Would a stressed business owner find this helpful and credible?
...
1. Are their specific pain points addressed?
2. Is the tone appropriate for their role/mindset?
3. Are the examples relevant to their daily experience?
4. Is the call to action aligned with their decision-making process?
5. Does it overcome their specific objections to switching?
```

This comprehensive prompt guide ensures every ebook you create will be strategically sound, technically excellent, legally compliant, and conversion-optimized while maintaining perfect brand consistency with Accrue guidelines and eliminating all green color references.